<aside class="admin-sidebar">
    ...
    <a href="{{ route('admin.users.index') }}" class="nav-link {{ request()->routeIs('admin.users.*') ? 'active' : '' }}">O Users</a>
    <a href="{{ route('admin.inventory-actions.index') }}" class="nav-link {{ request()->routeIs('admin.inventory-actions.*') ? 'active' : '' }}">|=| Stock Control</a>
    <a href="{{ route('admin.sale-actions.index') }}" class="nav-link {{ request()->routeIs('admin.sale-actions.*') ? 'active' : '' }}">||| Sales Control</a>
    ...
    <a href="{{ route('admin.inventory-report') }}" class="nav-link {{ request()->routeIs('admin.inventory-report') ? 'active' : '' }}">☰ Inventory </a>
    ...
    <a href="{{ route('admin.audit-log.index') }}" class="nav-link {{ request()->routeIs('admin.audit-log.*') ? 'active' : '' }}">\\\ Audit Log</a>
